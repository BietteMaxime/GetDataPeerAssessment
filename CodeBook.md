...
Our analysis have for goal to tidy the dataset from the Human Activity Recognition Using Smartphones Dataset[1].
...
* Save the tidy data set in a file. ("tidy.txt")
